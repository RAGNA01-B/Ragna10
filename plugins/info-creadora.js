...
lugar = official[0][0] == String(contact[0]) ? 'México' : official[1][0] == String(contact[0]) ? 'México' : official[2][0] == String(contact[0]) ? 'México' : official[3][0] == String(contact[0]) ? 'México' : country === '' ? lenguajeGB.smsContacto7() : country
