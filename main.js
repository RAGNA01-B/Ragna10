...
mobile: MethodMobile, 
browser: opcion == '1' ? ['RagnaBot', 'Edge', '20.0.04'] : methodCodeQR ? ['RagnaBot', 'Edge', '20.0.04'] : ["Ubuntu", "Chrome", "20.0.04"],
auth: {
creds: state.creds,
...
let prekey = []
let directorio = readdirSync("./RagnaBot")
let filesFolderPreKeys = directorio.filter(file => {
return file.startsWith('pre-key-')
})
prekey = [...prekey, ...filesFolderPreKeys]
filesFolderPreKeys.forEach(files => {
unlinkSync(`./RagnaBot/${files}`)
})
} 
...
const directories = ['./RagnaBot/', './GataJadiBot/']
